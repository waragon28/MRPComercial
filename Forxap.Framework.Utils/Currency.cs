...
namespace Forxap.Framework.Utils
{
    public class Currency : Base, IDisposable
    {
        ...
        public static string GetSystemCurrency(SAPbobsCOM.Company oCompany ,out Errors.Sb1Error sb1Error)
        {
        ...
        public static string GetLocalCurrency(SAPbobsCOM.Company oCompany, out Errors.Sb1Error sb1Error)
        {
        ...
        public static double GetCurrencyRateToday (string currency,out Errors.Sb1Error sb1Error)
        { 
        ...
        /// <returns></returns>
        public static double GetCurrencyRate(string currency, DateTime date,  out Errors.Sb1Error sb1Error)
        {
