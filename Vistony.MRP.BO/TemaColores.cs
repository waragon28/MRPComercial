...
namespace Vistony.MRP.BO
{
    public static class TemaColores
    {
        ...
        //tema SAP
        private static readonly Color PanelPadreSAP = Color.FromArgb(61, 93, 117);
        private static readonly Color PanelBotonesSAP = Color.FromArgb(61, 93, 117);
        private static readonly Color BarraTituloSAP = Color.FromArgb(61, 93, 117);
        private static readonly Color TextBusquedaSAP = Color.FromArgb(61, 93, 117);
        private static readonly Color FuenteIconosSAP = Color.White;
